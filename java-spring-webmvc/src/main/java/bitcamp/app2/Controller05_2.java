...
public class Controller05_2 {
  ...
  public Controller05_2() {
    ...
    list.add(new Board(7, "제목이빈다.7", "내용입니다,7", "홍길동7", 16, Date.valueOf("2019-11-01")));
    list.add(new Board(8, "제목이빈다.8", "내용입니다,8", "홍길동8", 17, Date.valueOf("2019-12-01")));
  ...
  public Object handler2() {
   // Gson gson = new Gson();
     return "안녕하세요";//String 타입은 그대로 출력한다.단 출력 문자열의 인코딩을 지정해야 한글이 깨지지 않느다.
  }
  ...
  public int handler3() {
   // Gson gson = new Gson();
     return 100;// primitiver 타입의 값도 그대로 출력한다.
  }
