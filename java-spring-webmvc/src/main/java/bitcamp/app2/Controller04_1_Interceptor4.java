...
//인터셉터 만들기
//=>프론트 컨트롤러와 페이지 컨트롤러 사이에 코드를 삽임하는 기술
//=>프론트 컨트롤러와 뷰 컴포넌트 사이베 코드를 삽입하는 기술
//
//인터셉터를 배치하기
//=>프론트 컨트롤러의 IoC 설정 파일에 IoC 배치 정보를 젖장하나다.
...
public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
  ...
  System.out.println("Intecptor4.preHandle()");
 ...
 @Override
  public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
   ...
   System.out.println("Inteceptor4.postHandle()");
