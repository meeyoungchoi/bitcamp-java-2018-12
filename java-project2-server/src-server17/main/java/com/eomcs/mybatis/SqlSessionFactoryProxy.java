...
public class SqlSessionFactoryProxy implements SqlSessionFactory {
  ...
  public void prepareForTransaction() {
    ...
    SqlSession sqlSession = this.openSession(false);//SQL세션패토리에 오픈세션 호출
    ...
    //그러면 여기에 sqlSession, true가 둘다 보관되는가?
    //오토커밋 펄스, 유즈트랜잭션 트루 이 두개의 값이 들어간다.
