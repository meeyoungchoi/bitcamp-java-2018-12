// 15단계: Mybatis의 동적 sql 적용하기
// 하나의 sql문으로 여러 요청을 처리할 수 있도록 
//
//작어
//1. sql 매퍼 파일 변경
//boardMapper.xml, lessonMapper.lml, memberMapper.xml, photoboardmapper.xml
//photofilemapper.xml
//sql 태그 사용: selelct 문에 공통으로 들어가는 컬럼 목록을 별도로 분리하여 관리한다.
//bind 태그 사용: 파라미터 값을 가지고 데이터를 sql을 생성할 때 사용한다.
