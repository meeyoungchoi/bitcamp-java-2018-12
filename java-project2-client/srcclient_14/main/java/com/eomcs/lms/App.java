...
public class App {
  ...
  public void service() {
    ...
    LessonDao lessonAgent = new LessonDao("localhost", 8888, "/lesson");
    ...
    MemberDao memberAgent = new MemberDao("localhost", 8888, "/member");
    ...
    BoardDao boardAgent = new BoardDao("localhost", 8888, "/board");
