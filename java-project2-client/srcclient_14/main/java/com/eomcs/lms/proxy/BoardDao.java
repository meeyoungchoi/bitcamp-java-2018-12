...
public class BoardDao  {
  ...
  public BoardDao(String serverAddr, int port, String rootPath) {
  ...
  public List<Board> findAll() {
    ...
    try (Socket socket = new Socket(this.serverAddr, this.port);
      ...
      return (List<Board>) in.readObject();
    	...
    	throw new RuntimeException(e);//메서드에 예외를 선언할수 없을 때 예외를 몰래 던지기 위해 runtimeException
    }
  }
  
  public void insert(Board board) /*throws RuntimeException*/ {//개발자에게 runttimeException이 발생할 가능성이 있다는 것을 알려주고 싶을때 적어라
