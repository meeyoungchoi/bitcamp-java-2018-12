//(34)과제 15단계: 멀티 스레드 활용하기
//여러 클라이언트 요청 처리시의 문제점과 해결책(멀티 스레드 적용)
...
import com.eomcs.lms.proxy.MemberDao;
...
public class App {
  ...
  public void service() {
    ...
    LessonDao lessonAgent = new LessonDao("192.168.0.31", 8888, "/lesson");
    ...
    MemberDao memberAgent = new MemberDao("192.168.0.31", 8888, "/member");
    ...
    BoardDao boardAgent = new BoardDao("192.168.0.31", 8888, "/board");
