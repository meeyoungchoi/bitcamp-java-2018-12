//lambda - functional innterface의 자격
package ch19.h;
...
public class Test06 {
	...
	static interface Player2 {
		...
		//인터페이스에 static 메서드나 default 메서드가 여러개 있더라도
	...
	public static void main(String[] args) {
		...
		//인터페이스가 아닌 추상 클래스는 람다 구현의 대상이 아니다. 컴파일 오류
		//Player4 p4 = () -> System.out.println("Player4...");//The target type of this expression must be a functional interface
	}
}
