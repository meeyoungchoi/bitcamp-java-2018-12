...
public class Test01 {
	...
	public static void main(String[] args) {
		...
		//Observer 패턴
		//어떤 클래스(인스턴스)에 변화가 일어 났을 때 다른 클래스에게 통보해 주는 것
		...
		//**상태가 부뀔 때 마다 다른 클래스에게 통지하는 기능을 추가한다.
		//상태가 바뀌었을 때 등록된 클래스에게 통지할 수 있도록 코드를 추갛나다.
		//Car 클래스에 다음 메서드 추가
		...
		//옵저버 패턴을 적용한 후에는 Car 클래스가 특정 상태에 놓일 떄 작업을 수행하는 
		//클래스를 쉽게 추가할 수 있다.
		//
