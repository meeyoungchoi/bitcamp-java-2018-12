//애플리케이션 예외의 종류: Exception 계열의 예외처리2
package ch21.c;
...
public class Test03 {
	public static void main(String[] args) //호출자에게 보고하는방법
		...
		//메서드 선언부에 throws
		// 이방식을 사용해야 하는 경우?
		// 이런 예외를 한 곳에서 처리하고 싶을 떄 이 방식을 사용한다.
		//=>"어이~~ 여기에 예외 처리하지 마! 호출자가 처리하도록 보고해 라는 의미이다.
