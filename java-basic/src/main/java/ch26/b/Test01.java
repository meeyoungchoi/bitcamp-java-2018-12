//mybatis 설정하기2
//db 접속 정보를 mybatis 설정 파일로 부터 분리하여 저장한다.
//이점: db접속 정보를 분리하면 db 접속 정보가 변경되었을 대 
...
public class Test01 {
	...
	//	InputStream inputStream2 = new FileInputStream(
				//"/home/meeyoungchoi/git/bitcamp-java-2018-12/java-basic/src/main/java/ch26/b/mybatis-config.xml");
