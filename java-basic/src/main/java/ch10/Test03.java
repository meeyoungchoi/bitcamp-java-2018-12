...
public class Test03 {
  ...
  public static void main(String[] args) {
    ...
    m1.display();//현실 세계에서 모니터의 각 값들이 유효한 기본 값으로 초기화 되지 않은 상태에서
                  //모니터를 켠다면? 까만 화면만 볼 분이다.
                  //사용자는 모니터가 고장난 줄 알고 에이에스를 요청할 것이다.
    
    //모니터를 사용하기 전에 인스턴스 필드의 값을 유효한 값으로 설정해야 한다. 인스턴스 값 초기화시키기
    //그래야 모니터의 기느응ㄹ 제대로 사용할 수 있다.
    //
    ...
    //=>인스턴스의 메서드를 사용하는데 문제가 업도록 인스턴스의 각 필드를 유효한 값으로
    //미리 초기화 했으면 좋겠습니다!
