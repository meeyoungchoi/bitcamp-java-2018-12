...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //변수=메서드명(); <==실행 결과 값을 되돌려 주는 메서드 라면. 물론 받지 않아도 된다.
    //변수=메서드명(값1, 값2,....); <=== 값을 받고 결과를 리턴하는 메서드라면
    
    //m1이라는 명령을 가진 블록을 실행하라
    m1();
    //1. m1()규칙에 따라 정의 한 메서드 블록으로 간다.
    //2. 메서드 바디를 실행한다.
    //3. 다시 원래 위치로 돌아온다.
    //4. 다음 줄을 실행한다.
    ...
    m1();
     ...
     //메서드 정의(definition)=>메서드 시그너처 + 메서드 바디
 ...
 * 
 *  }
 *  4. 명령어 블록을 실행할 때 값을 넘겨주지 않는다. 결과는 받는다.
 * 리턴타입 메서드명(변수선언1, 변수선언2, ....) {
 *  문장1;
 *  문장2;
 * 
