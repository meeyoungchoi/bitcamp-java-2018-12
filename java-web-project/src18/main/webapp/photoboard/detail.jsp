...
<jsp:useBean scope="request" id="photoboard" type="com.eomcs.lms.domain.PhotoBoard"></jsp:useBean>

<jsp:useBean scope="request" id="member" type="com.eomcs.lms.domain.Member"></jsp:useBean>
  <%if (board == null) { %>
...
<jsp:useBean scope="request" id="lesson" type="com.eomcs.lms.domain.Lesson"></jsp:useBean>
