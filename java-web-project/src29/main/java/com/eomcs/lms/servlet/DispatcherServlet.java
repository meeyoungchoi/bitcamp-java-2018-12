...
public class DispatcherServlet extends HttpServlet {
  ...
  private Object[] prepareParamValues(
    ...
    private Object getParameterValue(
        Parameter methodParam, //클라이언트가 호출할 메서드의 파라미터 정보
        String requestParamName,//클라잉언트가 보낸 request 파람
      ...
      if (methodParamType == int.class) {
        ...
        for (Part part : parts) {
          if (!part.getName().equals(methodParamType))
            continue;
          list.add(part);
        } 
  ...
  private Object getParameterValue(Parameter param, String value, HttpServletRequest request) {
