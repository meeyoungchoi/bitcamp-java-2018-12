//  http프로토콜 다루기 - httpServletRequest와 get/post
...
public class Servlet01 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
   ...
   //-http://localhost:8080/java-web/ex05/test01.html
    ...
    //http 프로토콜ㄹ로 통신을 하는 서블릿 컨테이너는
    //service() 메서드를 호출할 때
    //ServletRequest의 값으로 HttpServletRequest를 전달하낟.
    //ServletResponser의 값으로 HttpServletResponser를 전달한다.
    //따라서 service() 메서드의 파라미터 값은 원래
    //HttpServletRequest와 HttpServletResponse이다.
    //이들 객체는 http 프로토콜ㅇ르 다룬는 메서드가 추가되어 있다.
