//  멀티파으 파일 업로드 처리하기 - Servlet 3.0의 기본 라이브러리 사용
...
///
//=>web.xml에 설정할 수도 있고, 다음과 같이 애노테이션으로 설정할 수 도 있다.
...
public class Servlet05 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    res.setContentType("text/html;charset=UTF-8");//html형식에 맟춰져 있다.
